...
const ct = core.coordinate_transforms;
const constants = core.constants;
const core_origin = core.origin;
const core_tiling = core.tiling;

const CRS = @import("crs.zig").CRS;
const GnomonicProjection = @import("gnomonic.zig").GnomonicProjection;
const PolyhedralProjection = @import("polyhedral.zig").PolyhedralProjection;
